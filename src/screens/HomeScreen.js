...
const styles = StyleSheet.create({
  ...
  audioGrid: { flexDirection: "row", 
    flexWrap: "wrap", justifyContent: "space-between", marginBottom: 8 },
  audioCard: {
  ...
  audioCardTitle: { fontSize: 15, fontFamily: "Whyte-Regular",lineHeight:31, color: "#747474", lineHeight: 22 },
