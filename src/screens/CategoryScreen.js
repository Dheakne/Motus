      ...
      >
        {sessions.length === 0 ? (
          <View style={styles.emptyState}>
            <Text style={styles.emptyText}>Nenhuma sessão disponível ainda</Text>
          </View>
        ) : (
          sessions.map((session) => (
            ...
            >
              <View style={styles.sessionInfo}>
                ...
                <View style={styles.sessionTags}>
                  ...
                  <View style={[
                    ...
                    <Text style={[styles.tagText, { color: config.durationTagText }]}>
                  ...
                  <View style={[
                    ...
                    <Text style={[styles.tagText, { color: config.categoryTagText }]}>
              ...
              <View style={[styles.playButton, { backgroundColor: config.playBg }]}>
